      ...
      resourceEvents.headerItems.forEach(function (headerItem, index) {
        ...
        if (headerItem.count > 0 || headerItem.summary != undefined) {
          ...
          if (headerItem.summary != undefined) {
            ...
            var summary = _react2.default.createElement(_Summary2.default, { key: key, schedulerData: schedulerData, summary: headerItem.summary, left: _left3,
              width: _width3, top: _top });
